...
# Read the Excel file
raw <- read_excel(
  "D:\\1. M2 Development Economics\\0. Thesis\\Thesis\\RawData\\ds-059358__custom_19563131_spreadsheet.xlsx",
  sheet = "Data",
  col_names = FALSE
)
...
write_csv(
  final,
  "D:\\1. M2 Development Economics\\0. Thesis\\Thesis\\RawData\\prodcom_clean_long.csv"
)
