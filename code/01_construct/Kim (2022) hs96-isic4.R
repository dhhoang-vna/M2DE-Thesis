...
install.packages("remotes")   # from CRAN
...
hs_tbl <- read_csv(
  file.path(raw_data_dir, "CEPII BACI HS96", "hs6_2011.csv"),
...
# Export
setwd(file.path(raw_data_dir, "CEPII BACI HS96"))
write_csv(hs_isic, "hs96_isic4_withshares_2011.csv")
