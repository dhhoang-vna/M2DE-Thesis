...
log using "$LOGS\3 decomposition", replace
...
export delimited using "$DATA_PUBLIC\sector_moments.csv", replace
...
export delimited using "$OUTPUT_TABLES\decomposition_shares_over_time.csv", replace
...
graph export "$OUTPUT_FIGURES\decomposition_shares_over_time.png", replace width(2400)
...
export delimited using "$OUTPUT_TABLES\decomposition_3parts_over_time.csv", replace
...
graph export "$OUTPUT_FIGURES\decomposition_3parts_stacked_yearly.png", replace width(2400)
...
export delimited using "$OUTPUT_TABLES\decomposition_3parts_pooled_shares.csv", replace
...
graph export "$OUTPUT_FIGURES\decomposition_3parts_pooled_bar.png", replace width(2400)
...
file open tbl using "$OUTPUT_TABLES\decomposition.tex", write replace
...
file open tbl using "$OUTPUT_TABLES\decomposition.tex", write append
