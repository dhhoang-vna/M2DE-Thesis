...
* Rebuild the sector-level RHS after reloading `mfg_regdata'.
* Do not reuse `rhs' from Section 7, because generated controls such as
* dln_abs, dln_ppi, and dHHI may only have existed in memory there.
