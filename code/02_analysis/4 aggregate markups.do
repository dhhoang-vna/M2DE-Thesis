...
log using "$LOGS\3 decomposition (3)", replace
...
preserve
    ...
    export delimited using "$OUTPUT_TABLES\aggregate_markup_series.csv", replace
restore
...
esttab total within between entry negexit using "$OUTPUT_TABLES\decomposition1.tex", ///
    replace ///
...
preserve
    ...
    graph export "$OUTPUT_TABLES\aggregate_markup_compare_level.png", replace width(2000)
    ...
    graph export "$OUTPUT_TABLES\aggregate_markup_compare_log.png", replace width(2000)
    ...
    graph export "$OUTPUT_TABLES\aggregate_markup_compare_index.png", replace width(2000)
restore
