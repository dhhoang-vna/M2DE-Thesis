...
log using "D:\1. M2 Development Economics\0. Thesis\Thesis\Logs\kirov.log", replace text
...
tempname gridhold
postfile `gridhold' double alphaM ssr N using "$folder\Data\kirov_grid_results.dta", replace
...
save "$folder\Data\kirov_sample_flags.dta", replace
restore
...
esttab kirov_iv_diff kirov_iv_level using "$folder\Tables\kirov_iv.tex", replace ///
