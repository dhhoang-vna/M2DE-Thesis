...
log using "D:\1. M2 Development Economics\0. Thesis\Thesis\Logs\1 baseline_regressions", replace
...
preserve
sort firm_id year
collapse(mean) dln_rev change_IP output_IV Z_input age leverage lnSize ls_pre_filled export_revenue isic4 post2016 [aw=dom_sales], by(firm_id year)
tsset firm_id year
...
preserve
sort firm_id year
collapse(max) exit (mean) change_IP output_IV Z_input age l_leverage lnSize ls_pre_filled liquidity_ratio_x_ isic4 post2016 [aw=dom_sales], by(firm_id year)
tsset firm_id year
...
preserve
sort firm_id year
collapse(max) exit (mean) change_IP output_IV Z_input age l_leverage exporter ls_pre_filled liquidity_ratio_x_ isic4 post2016 [aw=dom_sales], by(firm_id year)
tsset firm_id year
